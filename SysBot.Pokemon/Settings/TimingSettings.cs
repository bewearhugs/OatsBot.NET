...
namespace SysBot.Pokemon
{
    public class TimingSettings
    {
        ...
        [Category(Misc), Description("Extra time in milliseconds to wait after clicking A to load your Camp. Used for SoJ EncounterBot.")]
        public int ExtraTimeLoadCamp { get; set; } = 0;
